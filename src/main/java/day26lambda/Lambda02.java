...
public class Lambda02 {
    ...
    public static void removeIfLengthGreaterThanFive(List<String> myList){ //stream() üzerinden sadece stream metholarına ulasabiliriz
        myList.removeIf(t->t.length()>5); //belli bir kosula göre eleman silmek istiyorsak,list ismini kullanarak removeIf methoduna ulasabiliriz,stream olmadan
