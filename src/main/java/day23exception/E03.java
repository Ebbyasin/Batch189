...
public class E03 {
    ...
    public static void main(String[] args) {
        /*
        1)Exception olsada olmasa da caliştirilmasi gereken kodlar var ise eger "finally block" icine
            yazariz
         *2)Database ile baglantiyi kesme isini yapan kodlar gibi kodlar her halukarda caliştirilmalidir
           iste bu tarz kodlari finally block icine koyariz
