...
public class Ternary01 {
    ...
    public static void main (String [] args){
        ...
        Object result2=(a>0 && b>0) || (a<0 && b<0) ? a*b : "Farklı işaretleri carpamıyorum" ;
        System.out.println(result2);
        //Object java da butun classlarin ortak parent (baba) idir..(==>>Hz. Adem gibidir)
        //Object in parenti yoktur
        //farkli data tipleri icin ortak bir variable olusturmak istediginizde data type
        // olarak object kullaniriz.
