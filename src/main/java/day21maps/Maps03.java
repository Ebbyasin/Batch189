...
public class Maps03 {
    ...
    public static void main(String[] args) {
        ...
        //String imizi tüm noktalama işaretlerini temizlemeliyiz
        s=s.replaceAll("\\p{Punct}","");
        System.out.println(s); //I like you like like

        //Tek parça olan stringimizi kelimelere ayirmak icin split(" ")kullanmalıyız
...
//"Hello Henry!" ==> H=2, e=2, l=2, o=1, n=1, r=1, y=1
        ...
        * 2)HashMap hizlidir,HashTable HashMap e göre yavaştır.(Neden yavaştır;hastTable da multi
          thread vardir)
        * 3)HashMap lere bir tane null key ve istediginiz kadar null value koyabilirsiniz
            HashTable lara keylerde ve value larda null kullanilmasina musade etmez.

          * *NOT: HashMap ve HashTable ikisi de entry leri rastgele sıralar.
