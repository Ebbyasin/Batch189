...
public class Lambda01 {
    ...
    public static void main(String[] args) {
        ...
        public static void printElements2(List<Integer> nums) {
            nums.stream().forEach(t -> System.out.print(t + " ")); // t'yi al ve bir boslukla yazdir

            //nums.stream() yapınca list imiz stream e donusuyor,yukaridan asagıya bir akıs verdik
            // stream deki methodları kullanabilmek icin

            // t --> lambda operatoru,(t için şunu yap) demektir.oraya x te koyabilirsin,ama neyse onu kullan.
